...
Se emplea las llamadas de OnTriggerEnter o OnCollisionEnter para detectar cuando entro en contacto con cualquier objeto segun el tag que le asignemos, los perfabs son comodos para este tipo de objetos ya que sus caracteristicas se comparten con el resto.
